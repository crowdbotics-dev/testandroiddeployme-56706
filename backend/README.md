...
## Project Structure
    ...
    ├── testandroiddeployme_56706  # Django project configurations
...
1. Clone this repo and `cd testandroiddeployme_56706`
...
2. Clone this repo and `cd testandroiddeployme_56706`
